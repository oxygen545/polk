...
class ArticlesTest < ApplicationSystemTestCase
  ...
  test "creating a Article" do
    ...
    fill_in "Heading", with: @article.heading
    fill_in "Link", with: @article.link
    fill_in "Subheading", with: @article.subheading
    fill_in "Subpage", with: @article.subpage_id
    fill_in "Subtitle", with: @article.subtitle
    fill_in "Title", with: @article.title
    fill_in "User", with: @article.user_id
    fill_in "Weight", with: @article.weight
