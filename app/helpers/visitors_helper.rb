module VisitorsHelper
	...
	def get_default_style
		...
		@mystyle = "<link href=\"https://fonts.googleapis.com/css?family=" + @style.primary_font + "\" rel='stylesheet'>"

		@mystyle = @mystyle + "<style type='text/css'> .pf { font-family: " + @style.primary_font + "; } "
